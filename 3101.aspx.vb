...
Partial Public Class HSM_Produce
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            If DR1 IsNot Nothing AndAlso DR1.Count > 0 Then
                ...
                Dim opr As New List(Of Double)() ' 避開 OR 關鍵字
    ...
    Private Sub SumTable()
        ...
        Dim calTmp As Double
        'Dim sumPA, sumSlabmw, sumCoilwm, sumDelay, sumShutdown, sumMR As Integer
        ...
        '99.10.26 PO運算式變更，dispostion的定義改為final_dis[鄭恒一]
        'PO(%)
        'strACCESS = "SELECT Day(product_date), SUM(coil_wm) from h_pmis_whqh " & _
        '            "WHERE " & _
        '            "no1_dispostion != '1' AND no1_dispostion != 'H' AND " & _
        '            "no2_dispostion != '1' AND no2_dispostion != 'H' AND " & _
        '            "no3_dispostion != '1' AND no3_dispostion != 'H' AND " & _
        '            "no4_dispostion != '1' AND no4_dispostion != 'H' AND " & _
        '            "no5_dispostion != '1' AND no5_dispostion != 'H' AND " & _
        '            "(Year(product_date) = " + Date.Today.ToString("yyyy") + ") and " & _
        '            "(Month(product_date) = " + Date.Today.ToString("MM") + ") " & _
