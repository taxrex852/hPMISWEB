...
Partial Public Class _4TNRL_Process
    ...
    ' 判斷是否超過DeviceDownThreshold分鐘未收到wh97
    ...
    Private Function CheckDeviceStatus(ByVal Conn As SqlConnection) As Boolean
        ...
        'strSQL = "SELECT TOP 1 process_date FROM h_pmis_wh73 ORDER BY process_date DESC"
    ...
    Private Sub createtable()
        ...
        strACCESS = String.Format("select ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod, ISNULL(A.product_day, B.product_day) as ProductDay from " & _
                    ...
                    "FULL OUTER JOIN " & _
                        ...
                        "from h_pmis_wh76 where shift_date='{0}' and shift_code='{1}' " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod, ISNULL(A.product_day, B.product_day) as ProductDay from " & _
                    ...
                    "FULL OUTER JOIN " & _
                        "(select SUBSTRING(shift_date, 7, 2) as product_day, SUM(gross_weight) as product_weight " & _
                        "from h_pmis_wh76 where shift_date='{1}' " & _
                        "Group by SUBSTRING(shift_date, 7, 2)) as B " & _
                    "ON A.product_day = B.product_day " & _
                    "ORDER BY ProductDay", _
        ...
        strACCESS = String.Format("select ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod, ISNULL(A.product_month, B.product_month) as ProductMonth from " & _
                    ...
                    "FULL OUTER JOIN " & _
                        ...
                        "from h_pmis_wh76 where shift_date like '{1}%' " & _
    ...
    Private Sub Link3502_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Link3502.Click
        Response.Redirect("http://w4mes.dsc.com.tw/3502.aspx")
    End Sub
    ...
    Protected Sub Link3504_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Link3504.Click
