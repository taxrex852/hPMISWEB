<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3406.aspx.vb" Inherits="hPMISWEB.HBM_Production" ContentType="text/html" ResponseEncoding="UTF-8" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid main-content px-4">
            ...
            <div class="card-custom mb-5">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4" style="color: white !important;">📋 HBM 本月生產進度</span>
                    </div>
                </div>
                                ...
                                <div class="ctbl-hdr-row">
                                    <table id="tblHeader1" class="auto-fit-table" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="gvhs_data">H型鋼 (Hxx)</td>
                                            <td class="gvhs_data">F型鋼 (Fxx)</td>
                                            <td class="gvhs_data">輕量型 (Lxx)</td>
                                        </tr>
                                    </table>
                                </div>
