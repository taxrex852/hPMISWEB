<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3404.aspx.vb" Inherits="hPMISWEB._3TNRL_Production" ContentType="text/html" ResponseEncoding="UTF-8" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid main-content px-4">
            ...
            <div class="card-custom mb-4">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4" style="color: white !important;">📋 #3TNRL 厚度與前段製程進度</span>
                    </div>
                </div>
            ...
            <div class="card-custom mb-5">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4" style="color: white !important;">📋 #3TNRL 強度與表面製程進度</span>
                    </div>
                </div>
                <div class="card-body p-3">
                    <div style="text-align: center;">
