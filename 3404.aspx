<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3404.aspx.vb" Inherits="hPMISWEB._3TNRL_Production" %>
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83 with(nolock)
...
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,process_date),0) as process_date,
cast(round(SUM(gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86 with(nolock)
where process_date between DATEADD(year,-1,getdate()) and getdate() 
...
round(ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0),2) as total_prod 
from (
select dateadd(m, datediff(m,0,wh83.process_date),0) as process_date,
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.carbon &lt;= 100 
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.carbon &lt;= 100
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
)
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &lt;= 40
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &lt;= 40
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &lt;= 50 and wh81.tensile &gt; 40 
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &lt;= 50 and wh81.tensile &gt; 40 
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &lt;= 60 and wh81.tensile &gt; 50 
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &lt;= 60 and wh81.tensile &gt; 50 
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &gt; 60
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.carbon &gt; 100 and wh81.tensile &gt; 60
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.carbon &gt; 100 and wh81.steel_grade_code like '6%'
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.carbon &gt; 100 and wh81.steel_grade_code like '6%'
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.inspection_code &lt; '6000' and wh81.inspection_code &gt;= '5000'
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.inspection_code &lt; '6000' and wh81.inspection_code &gt;= '5000'
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
)
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.inspection_code &lt; '5000' and wh81.inspection_code &gt;= '4000'
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.inspection_code &lt; '5000' and wh81.inspection_code &gt;= '4000'
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh83  as wh83 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh83.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh83.product_no,1, 7) = wh81.coil_no and wh81.inspection_code &lt; '4000' and wh81.inspection_code &gt;= '2000' 
group by  dateadd(m, datediff(m,0,wh83.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh86.process_date),0) as process_date, 
cast(round(SUM(wh86.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh86  as wh86 with(nolock), h_pmis_wh81  as wh81 with(nolock)
where wh86.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh86.coil_no = wh81.coil_no and wh81.inspection_code &lt; '4000' and wh81.inspection_code &gt;= '2000' 
group by  dateadd(m, datediff(m,0,wh86.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
)
