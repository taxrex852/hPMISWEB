<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3402.aspx.vb" Inherits="hPMISWEB._1TNRL_Production" %>
...
round(ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0),2) as total_prod 
from (
select dateadd(m, datediff(m,0,wh93.process_date),0) as process_date,
...
and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no and wh91.carbon &lt;= 100 
group by  dateadd(m, datediff(m,0,wh93.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh9b.process_date),0) as process_date, 
...
and wh9b.coil_no = wh91.coil_no and wh91.carbon &lt;= 100
group by  dateadd(m, datediff(m,0,wh9b.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
)
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh93  as wh93 with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh93.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &lt;= 40
group by  dateadd(m, datediff(m,0,wh93.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh9b.process_date),0) as process_date, 
cast(round(SUM(wh9b.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh9b  as wh9b with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh9b.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh9b.coil_no = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &lt;= 40
group by  dateadd(m, datediff(m,0,wh9b.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh93  as wh93 with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh93.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &lt;= 50 and wh91.tensile &gt; 40 
group by  dateadd(m, datediff(m,0,wh93.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh9b.process_date),0) as process_date, 
cast(round(SUM(wh9b.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh9b  as wh9b with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh9b.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh9b.coil_no = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &lt;= 50 and wh91.tensile &gt; 40 
group by  dateadd(m, datediff(m,0,wh9b.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh93  as wh93 with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh93.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &lt;= 60 and wh91.tensile &gt; 50 
group by  dateadd(m, datediff(m,0,wh93.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh9b.process_date),0) as process_date, 
cast(round(SUM(wh9b.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh9b  as wh9b with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh9b.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh9b.coil_no = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &lt;= 60 and wh91.tensile &gt; 50 
group by  dateadd(m, datediff(m,0,wh9b.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh93  as wh93 with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh93.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &gt; 60
group by  dateadd(m, datediff(m,0,wh93.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh9b.process_date),0) as process_date, 
cast(round(SUM(wh9b.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh9b  as wh9b with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh9b.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh9b.coil_no = wh91.coil_no and wh91.carbon &gt; 100 and wh91.tensile &gt; 60
group by  dateadd(m, datediff(m,0,wh9b.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
...
cast(round(SUM(g_weight)/1000,2) as float) as product_weight from h_pmis_wh93  as wh93 with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh93.process_date between DATEADD(year,-1,getdate()) and getdate() 
and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no and wh91.carbon &gt; 100 and wh91.steel_grade_code like '6%'
group by  dateadd(m, datediff(m,0,wh93.process_date),0)) as A 
FULL OUTER JOIN (
select dateadd(m, datediff(m,0,wh9b.process_date),0) as process_date, 
cast(round(SUM(wh9b.gross_weight)/1000,2) as float) as product_weight from h_pmis_wh9b  as wh9b with(nolock), h_pmis_wh91  as wh91 with(nolock)
where wh9b.process_date between DATEADD(year,-1,getdate()) and getdate() 
and wh9b.coil_no = wh91.coil_no and wh91.carbon &gt; 100 and wh91.steel_grade_code like '6%'
group by  dateadd(m, datediff(m,0,wh9b.process_date),0)) as B ON A.process_date = B.process_date and A.process_date = B.process_date
 )
