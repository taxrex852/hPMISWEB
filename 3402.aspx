<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3402.aspx.vb" Inherits="hPMISWEB._1TNRL_Production" ContentType="text/html" ResponseEncoding="UTF-8" %>
    ...
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function () {
            ...
            var optionDim = {
                ...
                title: { text: '#1TNRL 厚度與前段製程生產趨勢 (MT)', left: 'center', textStyle: { color: '#2c3e50', fontSize: 15, fontWeight: 'bold' } },
            ...
            var optionStr = {
                backgroundColor: 'transparent',
                title: { text: '#1TNRL 強度與表面製程生產趨勢 (MT)', left: 'center', textStyle: { color: '#2c3e50', fontSize: 15, fontWeight: 'bold' } },
                tooltip: { trigger: 'axis', axisPointer: { type: 'cross' } },
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid main-content px-4">
            ...
            <!-- ========== 第一層 Card：#1TNRL 生產趨勢圖 ========== -->
            <div class="card-custom mb-4 mt-2">
                <div class="card-header-custom">
                    <span class="fs-4" style="color: white !important;">📊 #1TNRL 生產趨勢</span>
            ...
            <div class="card-custom mb-4">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4" style="color: white !important;">📋 #1TNRL 厚度與前段製程進度</span>
                    </div>
                </div>
            ...
            <div class="card-custom mb-5">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4" style="color: white !important;">📋 #1TNRL 強度與表面製程進度</span>
                    </div>
                </div>
                <div class="card-body p-3">
                    <div style="text-align: center;">
