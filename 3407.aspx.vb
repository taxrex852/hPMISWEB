...
Partial Public Class _4TNRL_Production
    ...
    Private Sub TNRL4_Table1()
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                        "(select SUBSTRING(shift_date, 7, 2) as product_day, SUM(g_weight) as product_weight from h_pmis_wh73 " & _
                        "where shift_date like '{0}%' " & _
                        "and avg_width <= 1260 and avg_thickness <= 1500 " & _
                        "Group by SUBSTRING(shift_date, 7, 2)) as A " & _
                    "FULL OUTER JOIN " & _
                        "(select SUBSTRING(shift_date, 7, 2) as product_day, SUM(gross_weight) as product_weight from h_pmis_wh76 " & _
                        "where shift_date like '{0}%' " & _
    ...
    Private Sub TNRL4_Table2()
        ...
        'EXLC
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh73.shift_date, 7, 2) as product_day, SUM(wh73.g_weight) as product_weight from h_pmis_wh73 as wh73, h_pmis_wh71 as wh71 " & _
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.carbon <=" + EXLC_C.ToString + _
                                        " Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
                                        "and wh71.carbon <=" + EXLC_C.ToString + _
                                        "Group by SUBSTRING(wh76.shift_date, 7, 2)) as B " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh73.shift_date, 7, 2) as product_day, SUM(wh73.g_weight) as product_weight from h_pmis_wh73 as wh73, h_pmis_wh71 as wh71 " & _
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.carbon > " + EXLC_C.ToString + " and wh71.tensile <= 40 " & _
                                        " Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        ...
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.carbon > " + EXLC_C.ToString + _
                                        " and wh71.tensile > 40 and wh71.tensile <= 50 " & _
                                        "Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        ...
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.carbon > " + EXLC_C.ToString + _
                                        " and wh71.tensile > 50 and wh71.tensile <= 60 " & _
                                        "Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        ...
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.carbon > " + EXLC_C.ToString + _
                                        " and wh71.steel_grade_code like '6%' " & _
                                        "Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh73.shift_date, 7, 2) as product_day, SUM(wh73.g_weight) as product_weight from h_pmis_wh73 as wh73, h_pmis_wh71 as wh71 " & _
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.inspection_code < '6000' and wh71.inspection_code >= '5000' " & _
                                        "Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh73.shift_date, 7, 2) as product_day, SUM(wh73.g_weight) as product_weight from h_pmis_wh73 as wh73, h_pmis_wh71 as wh71 " & _
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.inspection_code < '5000' and wh71.inspection_code >= '4000' " & _
                                        "Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh73.shift_date, 7, 2) as product_day, SUM(wh73.g_weight) as product_weight from h_pmis_wh73 as wh73, h_pmis_wh71 as wh71 " & _
                                        "where wh73.shift_date like '{0}%' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
                                        "and wh71.inspection_code < '4000' and wh71.inspection_code >= '2000' " & _
                                        "Group by SUBSTRING(wh73.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh76.shift_date, 7, 2) as product_day, SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 " & _
                                        "where wh76.shift_date like '{0}%' and wh76.coil_no = wh71.coil_no " & _
    ...
    '                            "FULL OUTER JOIN " & _
    '                                "(select SUBSTRING(shift_date, 1, 4) as PYear, SUBSTRING(shift_date, 5, 2) as PMonth, " & _
    '                                "SUM(gross_weight) as product_weight from h_pmis_wh76 " & _
    ...
    '    strACCESS = String.Format("select ISNULL(A.PYear, B.PYear) as PYear, ISNULL(A.PMonth, B.PMonth) as PMonth, " & _
    '                            "ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
    '                                "(select SUBSTRING(wh73.shift_date, 1, 4) as PYear, SUBSTRING(wh73.shift_date, 5, 2) as PMonth, " & _
    '                                "SUM(wh73.g_weight) as product_weight from h_pmis_wh73 as wh73, h_pmis_wh71 as wh71 where " & _
    '                                "wh73.shift_date between '{0}' and '{1}' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
    '                                "and wh71.carbon <= " + EXLC_C.ToString & _
    '                                " Group by SUBSTRING(wh73.shift_date, 1, 4), SUBSTRING(wh73.shift_date, 5, 2)) as A " & _
    '                            "FULL OUTER JOIN " & _
    '                                "(select SUBSTRING(wh76.shift_date, 1, 4) as PYear, SUBSTRING(wh76.shift_date, 5, 2) as PMonth, " & _
    '                                "SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 where " & _
    '                                "shift_date between '{0}' and '{1}' and wh76.coil_no = wh71.coil_no " & _
    '                                "and wh71.carbon <= " + EXLC_C.ToString & _
    '                                " Group by SUBSTRING(wh76.shift_date, 1, 4), SUBSTRING(wh76.shift_date, 5, 2)) as B " & _
    '                                "ON A.PMonth = B.PMonth and A.PMonth = B.PMonth", _
    '                        tmpDate.ToString("yyyyMM") + "01", _
    '                        tmpDate.AddMonths(12).ToString("yyyyMM") + Date.DaysInMonth(Year(tmpDate.AddMonths(12)), Month(tmpDate.AddMonths(12))).ToString)
    ...
    '                        "wh73.shift_date between '{0}' and '{1}' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
    '                        "and wh71.carbon > " + EXLC_C.ToString + " " & _
    '                        "and wh71.tensile <= 50 and wh71.tensile > 40 " & _
    '                        " Group by SUBSTRING(wh73.shift_date, 1, 4), SUBSTRING(wh73.shift_date, 5, 2)) as A " & _
    '                    "FULL OUTER JOIN " & _
    '                        "(select SUBSTRING(wh76.shift_date, 1, 4) as PYear, SUBSTRING(wh76.shift_date, 5, 2) as PMonth, " & _
    '                        "SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 where " & _
    ...
    '                        "wh73.shift_date between '{0}' and '{1}' and SUBSTRING(wh73.product_no,1, 7) = wh71.coil_no " & _
    '                        "and wh71.carbon > " + EXLC_C.ToString + " " & _
    '                        "and wh71.tensile <= 60 and wh71.tensile > 50 " & _
    '                        " Group by SUBSTRING(wh73.shift_date, 1, 4), SUBSTRING(wh73.shift_date, 5, 2)) as A " & _
    '                    "FULL OUTER JOIN " & _
    '                        "(select SUBSTRING(wh76.shift_date, 1, 4) as PYear, SUBSTRING(wh76.shift_date, 5, 2) as PMonth, " & _
    '                        "SUM(wh76.gross_weight) as product_weight from h_pmis_wh76 as wh76, h_pmis_wh71 as wh71 where " & _
