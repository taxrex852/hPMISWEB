<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3103.aspx.vb" Inherits="hPMISWEB._2TNRL_Produce" %>
            ...
            try {
                if (typeof chartData !== 'undefined') {
                    ...
                    percentChart.setOption({
                        backgroundColor: 'transparent', title: { text: '📈 精整#2 生產效益趨勢 (百分比)', left: 'center', textStyle: { color: '#2c3e50', fontSize: 16, fontWeight: 'bold' } },
                    ...
                    weightChart.setOption({
                        backgroundColor: 'transparent', title: { text: '⚖️ 精整#2 生產重量趨勢 (MT)', left: 'center', textStyle: { color: '#2c3e50', fontSize: 16, fontWeight: 'bold' } },
...
C AS (
    ...
    INNER JOIN h_pmis_wh95 w1 ON wh.mno = w1.coil_no 
...
ORDER BY process_date">
            ...
            <div class="card-custom mb-4 mt-2">
                <div class="card-header-custom">
                    <span class="fs-4 text-white">📊 精整#2 生產效益與重量趨勢</span>
            ...
            <div class="card-custom mb-4">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4 text-white">📋 精整#2 每日生產履歷</span>
            ...
            <div class="card-custom mb-5">
                <div class="card-header-custom">
                    <div>
                        <span class="fs-4 text-white">📋 精整#2 當月生產履歷</span>
