<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComputerHardwareMatch.aspx.cs" Inherits="WebApplication2.ComputerHardwareMatch" %>
            ...
            <asp:Panel ID="Panel1" runat="server">
                ...
                <p>
                    電腦序號：<asp:TextBox ID="TB_computer_serial" runat="server" ReadOnly="True"></asp:TextBox>
                     <asp:TextBox ID="TB_computer_hardware_match_serial" runat="server" Visible="False"></asp:TextBox>
                  
                </p>
                  <p>
                    目前電腦已配對硬體：<asp:TextBox ID="TB_hardwareMatch" runat="server" ReadOnly="True"></asp:TextBox>
                   ...
                   <p class="auto-style1">
                    修改電腦配對硬體： 
                    <asp:DropDownList ID="DL_hardware1" runat="server" DataSourceID="SqlDataSource1" DataTextField="material_type" DataValueField="material_type" AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="DL_hardware1_SelectedIndexChanged" >
                        <asp:ListItem Selected="True"></asp:ListItem>
                    </asp:DropDownList>
                       <asp:DropDownList ID="DL_hardware2" runat="server" DataSourceID="SqlDataSource2" DataTextField="material_name" DataValueField="material_serial"  AutoPostBack="True" >
                       
                    </asp:DropDownList>
                   
                   
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="select material_type from material_master where iscomputer ='D' group by material_type"></asp:SqlDataSource>
...
where iscomputer ='C' and computer_serial is not null  ORDER BY computer_serial DESC"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_computer_hardware_match" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand=""></asp:SqlDataSource>
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource_computer_hardware_match" ForeColor="#333333" GridLines="None" PageSize="50" >
                    ...
                    <Columns>
                        <asp:TemplateField>
                         ...
                         <asp:BoundField DataField="computer_hardware_match_serial" HeaderText="授權流水號" SortExpression="computer_hardware_match_serial">
                        ...
                        <asp:BoundField DataField="material_type" HeaderText="設備種類" SortExpression="material_type">
                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                        </asp:BoundField>
