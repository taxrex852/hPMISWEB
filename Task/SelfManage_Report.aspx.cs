...
{
    public partial class SelfManage_Report : System.Web.UI.Page
    {
        ...
        protected void BT_Print_Click(object sender, EventArgs e)
        {
                ...
                SqlDataAdapter sda = new SqlDataAdapter(" select Mat_Master.material_name,Mat_Master.safety_quantity,Mat_Master.material_unit,Sto_Info.storage_id, " +
            ...
            rd.SetParameterValue("盤點報表", "Y6P2 自主管理室盤點報表");
            rd.SetParameterValue("排序方式", "(依儲位排序)");

            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, HttpContext.Current.Response, false, "自主管理室盤點報表");
