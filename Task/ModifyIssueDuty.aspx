...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table>
        <td style="vertical-align: top">
            ...
            <asp:SqlDataSource ID="SqlDataSource_PageLoad_Duty_AssistantStyleMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT [IssueID], [Duty_AssistantStyleID] FROM [Duty_AssistantStyleMap] WHERE ([IssueID] = @IssueID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="LB_ID" Name="IssueID" PropertyName="Text" Type="Int64" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource_PageLoad_Duty_Fail_LevelMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT [IssueID], [Duty_Fail_LevelID] FROM [Duty_Fail_LevelMap] WHERE ([IssueID] = @IssueID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="LB_ID" Name="IssueID" PropertyName="Text" Type="Int64" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource_PageLoad_Duty_Fail_StyleMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT [IssueID], [Duty_Fail_StyleID] FROM [Duty_Fail_StyleMap] WHERE ([IssueID] = @IssueID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="LB_ID" Name="IssueID" PropertyName="Text" Type="Int64" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource_PageLoad_IssueAssistantMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT IssueAssistantMap.IssueID, IssueAssistantMap.employee_id, employee.row_id FROM IssueAssistantMap INNER JOIN employee ON IssueAssistantMap.employee_id = employee.employee_id WHERE (IssueAssistantMap.IssueID = @IssueID)">
                <SelectParameters>
                    <asp:QueryStringParameter Name="IssueID" QueryStringField="IssueID" Type="Int64" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource_PageLoad_IssueDuty" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT [IssueID], [Duty_Start], [Duty_End], [Duty_Work_Time], [Duty_Fail_Style], [Duty_Fail_Level] FROM [IssueDuty] WHERE ([IssueID] = @IssueID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="LB_ID" Name="IssueID" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <asp:SqlDataSource ID="SqlDataSource_PageLoad_IssueDutyDetail" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" DataSourceMode="DataReader" SelectCommand="SELECT IssueDutyDetail.IssueID, IssueDutyDetail.Duty_Start, IssueDutyDetail.Duty_End, IssueDutyDetail.Duty_Work_Time, IssueDutyDetail.Duty_Fail_Style, IssueDutyDetail.Duty_Person, employee.employee_name FROM IssueDutyDetail INNER JOIN employee ON IssueDutyDetail.Duty_Person = employee.employee_id WHERE (IssueDutyDetail.IssueID = @IssueID)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="LB_ID" Name="IssueID" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        ...
        時：<asp:DropDownList ID="DL_StartHour" runat="server">
            ...
            <p>
                值勤人員：<asp:DropDownList ID="DL_IssueManager_Duty" runat="server" DataSourceID="SqlDataSource_PageLoad_IssueDutyDetail" DataTextField="employee_name" DataValueField="Duty_Person">
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource_Employee_List" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT  row_id,employee_id, [employee_name] FROM [employee] where employee_Employed = 1 and row_id &lt; 19  ORDER BY [employee_id]"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_Employee_List0" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT  employee_id, [employee_name] FROM [employee] where employee_Employed = 1 and row_id &lt; 19  ORDER BY [employee_id]"></asp:SqlDataSource>
            </p>
         ...
         <asp:CheckBoxList ID="CBL_IssueManager" runat="server" DataSourceID="SqlDataSource_Employee_List" DataTextField="employee_name" DataValueField="employee_id" RepeatColumns="5">
            ...
            <p>
                主題負責人員：<asp:DropDownList ID="DL_IssueManager" runat="server" DataSourceID="SqlDataSource_Employee_List0" DataTextField="employee_name" DataValueField="employee_id">
                </asp:DropDownList>
            </p>
            ...
            <p>
                ...
                <asp:SqlDataSource ID="SqlDataSource_SendDuty_Fail_LevelMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT * FROM [Duty_Fail_LevelMap]" DataSourceMode="DataReader"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_SendDuty_Fail_StyleMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT * FROM [Duty_Fail_StyleMap]" DataSourceMode="DataReader"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_SendAssistantStyleMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT * FROM [Duty_AssistantStyleMap]" DataSourceMode="DataReader"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_SendIssueDuty" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT * FROM [IssueDuty]" DataSourceMode="DataReader"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_SendIssueDutyDetail" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT [IssueID], [Duty_Start], [Duty_End], [Duty_Work_Time], [Duty_Fail_Style], [Duty_Person] FROM [IssueDutyDetail]" DataSourceMode="DataReader"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_SendIssueAssistantMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT * FROM [IssueAssistantMap]" DataSourceMode="DataReader"></asp:SqlDataSource>
                <asp:SqlDataSource ID="SqlDataSource_SendIssueSystemMap" runat="server" ConnectionString="<%$ ConnectionStrings:Y6P2_MaterialsConnectionString %>" SelectCommand="SELECT [IssueID], [SystemID] FROM [IssueSystemMap]" DataSourceMode="DataReader"></asp:SqlDataSource>
            </p>
            <p>
                &nbsp;
            </p>
