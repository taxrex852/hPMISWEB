...
Partial Public Class _1TNRL_Production
    ...
    Private Sub TNRL1_Table1()
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                        "(select SUBSTRING(shift_date, 7, 2) as product_day, SUM(g_weight) as product_weight from h_pmis_wh93 " & _
                        "where shift_date like '{0}%' " & _
                        "and avg_width <= 1260 and avg_thickness <= 1500 " & _
                        "Group by SUBSTRING(shift_date, 7, 2)) as A " & _
                    "FULL OUTER JOIN " & _
                        "(select SUBSTRING(shift_date, 7, 2) as product_day, SUM(gross_weight) as product_weight from h_pmis_wh9b " & _
                        "where shift_date like '{0}%' " & _
    ...
    Private Sub TNRL1_Table2()
        ...
        'EXLC
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh93.shift_date, 7, 2) as product_day, SUM(wh93.g_weight) as product_weight from h_pmis_wh93 as wh93, h_pmis_wh91 as wh91 " & _
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.carbon <=" + EXLC_C.ToString + _
                                        " Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
                                        "and wh91.carbon <=" + EXLC_C.ToString + _
                                        "Group by SUBSTRING(wh9b.shift_date, 7, 2)) as B " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh93.shift_date, 7, 2) as product_day, SUM(wh93.g_weight) as product_weight from h_pmis_wh93 as wh93, h_pmis_wh91 as wh91 " & _
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.carbon > " + EXLC_C.ToString + " and wh91.tensile <= 40 " & _
                                        " Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        ...
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.carbon > " + EXLC_C.ToString + _
                                        " and wh91.tensile > 40 and wh91.tensile <= 50 " & _
                                        "Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        ...
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.carbon > " + EXLC_C.ToString + _
                                        " and wh91.tensile > 50 and wh91.tensile <= 60 " & _
                                        "Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        ...
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.carbon > " + EXLC_C.ToString + _
                                        " and wh91.steel_grade_code like '6%' " & _
                                        "Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh93.shift_date, 7, 2) as product_day, SUM(wh93.g_weight) as product_weight from h_pmis_wh93 as wh93, h_pmis_wh91 as wh91 " & _
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.inspection_code < '6000' and wh91.inspection_code >= '5000' " & _
                                        "Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh93.shift_date, 7, 2) as product_day, SUM(wh93.g_weight) as product_weight from h_pmis_wh93 as wh93, h_pmis_wh91 as wh91 " & _
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.inspection_code < '5000' and wh91.inspection_code >= '4000' " & _
                                        "Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
        ...
        strACCESS = String.Format("select ISNULL(A.product_day, B.product_day) as ProductDay, ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
                                        "(select SUBSTRING(wh93.shift_date, 7, 2) as product_day, SUM(wh93.g_weight) as product_weight from h_pmis_wh93 as wh93, h_pmis_wh91 as wh91 " & _
                                        "where wh93.shift_date like '{0}%' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
                                        "and wh91.inspection_code < '4000' and wh91.inspection_code >= '2000' " & _
                                        "Group by SUBSTRING(wh93.shift_date, 7, 2)) as A " & _
                                  "FULL OUTER JOIN " & _
                                        "(select SUBSTRING(wh9b.shift_date, 7, 2) as product_day, SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 " & _
                                        "where wh9b.shift_date like '{0}%' and wh9b.coil_no = wh91.coil_no " & _
    ...
    '                            "FULL OUTER JOIN " & _
    '                                "(select SUBSTRING(shift_date, 1, 4) as PYear, SUBSTRING(shift_date, 5, 2) as PMonth, " & _
    '                                "SUM(gross_weight) as product_weight from h_pmis_wh9b " & _
    ...
    '    strACCESS = String.Format("select ISNULL(A.PYear, B.PYear) as PYear, ISNULL(A.PMonth, B.PMonth) as PMonth, " & _
    '                            "ISNULL(A.product_weight, 0) + ISNULL(B.product_weight, 0) as total_prod from " & _
    '                                "(select SUBSTRING(wh93.shift_date, 1, 4) as PYear, SUBSTRING(wh93.shift_date, 5, 2) as PMonth, " & _
    '                                "SUM(wh93.g_weight) as product_weight from h_pmis_wh93 as wh93, h_pmis_wh91 as wh91 where " & _
    '                                "wh93.shift_date between '{0}' and '{1}' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
    '                                "and wh91.carbon <= " + EXLC_C.ToString & _
    '                                " Group by SUBSTRING(wh93.shift_date, 1, 4), SUBSTRING(wh93.shift_date, 5, 2)) as A " & _
    '                            "FULL OUTER JOIN " & _
    '                                "(select SUBSTRING(wh9b.shift_date, 1, 4) as PYear, SUBSTRING(wh9b.shift_date, 5, 2) as PMonth, " & _
    '                                "SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 where " & _
    '                                "shift_date between '{0}' and '{1}' and wh9b.coil_no = wh91.coil_no " & _
    '                                "and wh91.carbon <= " + EXLC_C.ToString & _
    '                                " Group by SUBSTRING(wh9b.shift_date, 1, 4), SUBSTRING(wh9b.shift_date, 5, 2)) as B " & _
    '                                "ON A.PMonth = B.PMonth and A.PMonth = B.PMonth", _
    '                        tmpDate.ToString("yyyyMM") + "01", _
    '                        tmpDate.AddMonths(12).ToString("yyyyMM") + Date.DaysInMonth(Year(tmpDate.AddMonths(12)), Month(tmpDate.AddMonths(12))).ToString)
    ...
    '                        "wh93.shift_date between '{0}' and '{1}' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
    '                        "and wh91.carbon > " + EXLC_C.ToString + " " & _
    '                        "and wh91.tensile <= 50 and wh91.tensile > 40 " & _
    '                        " Group by SUBSTRING(wh93.shift_date, 1, 4), SUBSTRING(wh93.shift_date, 5, 2)) as A " & _
    '                    "FULL OUTER JOIN " & _
    '                        "(select SUBSTRING(wh9b.shift_date, 1, 4) as PYear, SUBSTRING(wh9b.shift_date, 5, 2) as PMonth, " & _
    '                        "SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 where " & _
    ...
    '                        "wh93.shift_date between '{0}' and '{1}' and SUBSTRING(wh93.product_no,1, 7) = wh91.coil_no " & _
    '                        "and wh91.carbon > " + EXLC_C.ToString + " " & _
    '                        "and wh91.tensile <= 60 and wh91.tensile > 50 " & _
    '                        " Group by SUBSTRING(wh93.shift_date, 1, 4), SUBSTRING(wh93.shift_date, 5, 2)) as A " & _
    '                    "FULL OUTER JOIN " & _
    '                        "(select SUBSTRING(wh9b.shift_date, 1, 4) as PYear, SUBSTRING(wh9b.shift_date, 5, 2) as PMonth, " & _
    '                        "SUM(wh9b.gross_weight) as product_weight from h_pmis_wh9b as wh9b, h_pmis_wh91 as wh91 where " & _
