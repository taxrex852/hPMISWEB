            ...
            try {
                if (typeof chartData !== 'undefined') {
                    ...
                    defectChart.setOption({
                        ...
                        title: { text: '退火爐 #4 缺陷月累計趨勢 (MT)', left: 'center', textStyle: { color: '#2c3e50', fontSize: 15, fontWeight: 'bold' } },
...
ORDER BY product_month">
            ...
            <div class="card-custom mb-4 mt-2">
                <div class="card-header-custom">
                    <span class="fs-4" style="color: white !important;">&#128202; 退火爐 #4 缺陷月累計趨勢</span>
