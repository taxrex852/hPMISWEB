<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3302.aspx.vb" Inherits="hPMISWEB._1TNRL_Delay" %>
<%@ Register TagPrefix="hPMISWEB" TagName="PageHeader" Src="~/include/header.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
<title>1TNRL_Delay</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;
                ...
                <tr>
                    <td>
                        ...
                        <input id="Radio2" type="radio" onclick="create_data(2)" />分
                    </td>
                </tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;
