<%@ Page Language="vb" AutoEventWireup="false" Codebehind="3506.aspx.vb" Inherits="hPMISWEB.HBM_Process" %>
...
<head runat="server">
    ...
    <link href="/css/diagram.css" media="all" rel="stylesheet" type="text/css" />
    <title>HBM_Process</title>
</head>

<script language="JavaScript" type="text/javascript"></script>

<%--<body onload="alert('正式生產資料未上線');">--%>
<body>
    <form id="form1" runat="server">
        <hPMISWEB:PageHeader ID="ph" runat="server" />
        <img src="images/HBM_Process.JPG" style="left: 118px; position: absolute; top: 408px; width: 680px;" />
            ...
            <ContentTemplate>
                ...
                <table style="border-collapse: collapse; z-index: 101; left: 88px; position: absolute;
                    ...
                    <tr>
                        ...
                        <td class="Lgvhs_data" colspan="2">
                            最後成捆編號：<asp:Label ID="lblLast" runat="server" Text="N/A"></asp:Label></td>
                    </tr>
                    <tr>
                        ...
                        <td class="Lgvhs_data" style="width: 201px">
                            重量</td>
                        <td class="Ldata" style="width: 201px; text-align: left;">
                    ...
                    <tr>
                        ...
                        <td class="Lgvhs_data" style="width: 201px">
                            Product Size Code</td>
                        <td class="Ldata" style="width: 201px; text-align: left;">
                            <asp:Label ID="lblP" runat="server" ForeColor="Blue" Text="N/A"></asp:Label>
                            </td>
                    </tr>
                    <tr>
                        <td class="Lgvhs_data" style="width: 80px">
