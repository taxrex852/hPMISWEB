...
Partial Public Class _3703

    Inherits System.Web.UI.Page
    Public Const PAGE_ID = "3703"
    ...
    Private Sub MainProcess_3()
        ...
        GetData_Time(1, True)
        ProcessT(1) = g_aDataSet2(0)
        Read_Last_DataTime(1, ProcessT(1))
        ...
        '                    "Where fn=3" &
        '                    "ORDER BY sys_process_date DESC "
        g_strSQL = "SELECT TOP(1) n1_gas_lea_decforCO, n2_gas_lea_decforCO, n3_gas_lea_decforCO, n4_gas_lea_decforCO, n5_gas_lea_decforCO, n6_gas_lea_decforCO, n7_gas_lea_decforCO, n8_gas_lea_decforCO, n9_gas_lea_decforCO, " &
                                                              "n10_gas_lea_decforCO, n11_gas_lea_decforCO, n12_gas_lea_decforCO, n13_gas_lea_decforCO, n14_gas_lea_decforCO, n15_gas_lea_decforCO, n16_gas_lea_decforCO, n17_gas_lea_decforCO, n18_gas_lea_decforCO, " &
                                                              "n19_gas_lea_decforCO, n20_gas_lea_decforCO, n21_gas_lea_decforCO, n22_gas_lea_decforCO, n23_gas_lea_decforCO, n24_gas_lea_decforCO, n25_gas_lea_decforCO, n26_gas_lea_decforCO, n27_gas_lea_decforCO, " &
                                                              "n28_gas_lea_decforCO, n29_gas_lea_decforCO, n30_gas_lea_decforCO, n31_gas_lea_decforCO, n32_gas_lea_decforCO, n33_gas_lea_decforCO, n34_gas_lea_decforCO, n35_gas_lea_decforCO " &
                                "FROM h_pmis_fp06 " &
                                "ORDER BY sys_process_date DESC "

        g_strSQL_maxco = "SELECT max_co FROM vw_3703_maxco "
    ...
    Private Sub GetData_CO(ByVal intCount As Integer, Optional ByVal redimArray As Boolean = True, Optional ByVal startIdx As Integer = 0)
        ...
        Try
            ...
            g_sConn = New SqlConnection(getHBMConnStr(Application("HBMConnStr"))) '1091229 新增HBMPMIS連線字串
