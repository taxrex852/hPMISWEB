<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3202.aspx.vb" Inherits="hPMISWEB._4TNRL_Defect" ContentType="text/html" ResponseEncoding="UTF-8" %>
            ...
            try {
                if (typeof chartData !== 'undefined') {
                    ...
                    defectChart.setOption({
                        ...
                        title: { text: 'TNRL #4 缺陷月累計趨勢 (MT)', left: 'center', textStyle: { color: '#2c3e50', fontSize: 15, fontWeight: 'bold' } },
...
ORDER BY product_month">
            ...
            <div class="card-custom mb-4 mt-2">
                <div class="card-header-custom">
                    <span class="fs-4" style="color: white !important;">&#128202; TNRL #4 缺陷月累計趨勢</span>
