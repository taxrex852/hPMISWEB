<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3401.aspx.vb" Inherits="hPMISWEB.TPM_Produce" ContentType="text/html" ResponseEncoding="UTF-8" %>
                                ...
                                <div class="ctbl-hdr-row">
                                    <table id="tblHeader1" class="auto-fit-table" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="gvhs_data">ETNG</td>
                                            <td class="gvhs_data">WTNG</td>
                                            <td class="gvhs_data">NTNG</td>
                                            <td class="gvhs_data">NTCG</td>
                                            <td class="gvhs_data">ETCG</td>
                                            <td class="gvhs_data">MDSZ</td>
                                        </tr>
                                    </table>
                                    <table id="tblHeader3" class="auto-fit-table" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td class="gvhs_data">NRWD</td>
                                            <td class="gvhs_data">MDWD</td>
                                            <td class="gvhs_data">WIWD</td>
                                        </tr>
                                    </table>
                                </div>
