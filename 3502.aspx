<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="3502.aspx.vb" Inherits="hPMISWEB._1TNRL_Process" %>
<%@ Register TagPrefix="hPMISWEB" TagName="PageHeader" Src="~/include/header.ascx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
<title>1TNRL_Process</title>
...
<body>
    ...
    <hPMISWEB:PageHeader ID="ph" runat="server" />
        <img src="images/1TNRL_Process_New.JPG" style="left: 160px; position: absolute; top: 408px" />    
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <table style="border-collapse: collapse; left: 88px; position: absolute; top: 248px;">
                    <tr>
                        ...
                        <td class="Lgvhs_data" colspan="2">
                            最後完軋鋼捲：<asp:Label ID="lblLast" runat="server" Text="N/A"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Ldata" style="width: 250px; text-align: left;">
                            <asp:Label ID="lblKind" runat="server" ForeColor="Blue" Text="N/A"></asp:Label>
                        </td>
                    </tr>
                </table>
            ...
            <tr>
                ...
                <td class="Ldata">
                    <asp:Label ID="lblData" runat="server" ForeColor="Blue" Text="N/A"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="Lgvhs_data">
                ...
                <td class="Ldata">
                    <asp:Label ID="lblNow" runat="server" ForeColor="Blue" Text="N/A"></asp:Label>
                </td>
            </tr>
        </table>
            </ContentTemplate>
        ...
        <asp:LinkButton ID="Link3504" runat="server" Font-Names="Times New Roman" Font-Size="Medium">#3 TNRL</asp:LinkButton>
