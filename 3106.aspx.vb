...
Partial Public Class HBM_Produce
    ...
    Private Sub HBMTable()
        ...
        ' 用於儲存各班的基礎數值 (全部來自 mp01)
        Dim slab_wgt_pdi(2) As Double ' 代表 PA (全重)
        Dim slab_wgt(2) As Double     ' 代表 flag = 1
        Dim mr_wgt(2) As Double       ' 代表 flag in (2,3)
